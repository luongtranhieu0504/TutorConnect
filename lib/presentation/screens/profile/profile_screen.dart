...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  @override
  void initState() {
    _bloc.logOutBroadcast.listen((state) {
      state.when(
        success: (data) {
          if (data) {
            ...
            children: [
              if (user.typeRole == "Student")
                _profileCard(Icons.favorite, "Gia sư yêu thích", () {
                    context.push(Routes.favoritePage);
                  }
                ),
              _profileCard(
                  Icons.nights_stay_rounded, "Giao diện & Chủ đề", () =>
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(user.typeRole == "Student" ? "Học sinh" : "Gia sư",
                      style: AppTextStyles(context).bodyText2.copyWith(
                        fontSize: 16,
                      )
                  ),
        ...
        return StatefulBuilder(
            builder: (context, setState) {
              final themeProvider = Provider.of<ThemeProvider>(
                  context); // 👈 listen: true để rebuild
