...
// import 'package:tutorconnect/domain/models/users_model.dart';
...
//
//   const ScheduleFormScreen({super.key, required this.student, required this.scheduleId});
//
//   @override
...
//                       child: ListTile(
//                         title: Text(
//                             'Thứ ${slot.weekday}: ${slot.startTime.format(context)} - ${slot.endTime.format(context)}'),
//                         trailing: IconButton(
...
//     );
//     _bloc.updateScheduleAndNotify(widget.scheduleId, schedule);
