...
//
//     NotificationService().setCurrentConversationId(widget.conversationId);
...
//     });
//
//     _bloc.createOrGetScheduleBroadcast.listen((state) {
//       state.when(
//         loading: () {
//           showDialog(
//             context: context,
...
//     final state = _bloc.state as ChatSuccess;
